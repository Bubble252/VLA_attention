...
| π0/π0.5 | VLM 与 flow/action expert；连续动作 | 代表连续动作生成和较强开放世界泛化 | π0、π0.5 必须分开登记；归因路径和 flow time 需审计 | 第二 VLA 主线 |
| MolmoAct2 | layer-wise cross-attention action expert | 可作为显式 cross-attention 对照 | 代码/权重和数据配置需要单独核验 | 用户指定候选 |
