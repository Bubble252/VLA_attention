...
```bash
SWEEP_STEPS=100 CUDA_VISIBLE_DEVICES=1 bash server/run_f0_lambda_sweep_train.sh
SWEEP_STEPS=100 CUDA_VISIBLE_DEVICES=1 bash server/run_f0_lambda_sweep_eval.sh
```
