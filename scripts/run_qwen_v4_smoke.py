...
def main():
 ...
 p=argparse.ArgumentParser(); p.add_argument('--model',type=Path,required=True); p.add_argument('--dino',type=Path,required=True); p.add_argument('--dataset-root',type=Path,required=True); p.add_argument('--manifest',type=Path,required=True); p.add_argument('--cache',type=Path,required=True); p.add_argument('--lora-config',type=Path,required=True); p.add_argument('--output',type=Path,required=True); p.add_argument('--checkpoint',type=Path,default=None); p.add_argument('--max-steps',type=int,default=20); p.add_argument('--lambda-ret',type=float,default=.1); p.add_argument('--lambda-sem',type=float,default=.1); p.add_argument('--seed',type=int,default=17); a=p.parse_args()
