...
def main() -> int:
    ...
    try:
      for step in range(a.max_steps):
        ...
        sem=semantic_map_kl(student,teacher,teacher_temperature=a.teacher_temperature); warmup=min(1.0,(step+1)/a.semantic_warmup_steps) if a.semantic_warmup_steps else 1.0; effective_lambda=a.lambda_sem*warmup; loss=out.loss+effective_lambda*sem
